        ...
        confirmHandler: async (paymentMethod, _, intentCreationCallback) => {
          ...
          const { paymentIntent, customer } = await fetchAPI(
            "/(api)/(stripe)/create",
            {
              ...
              body: JSON.stringify({
                name: fullName || email.split("@")[0], // customer name
                email: email,
                amount: amount,
          ...
          // client_secret allows us to make payment using the
          // payment intent we created
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Text
            className={
              "text-md text-general-200 font-JakartaRegular mt-3 text-center"
            }
          >
